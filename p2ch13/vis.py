...
from p2ch13.dsets import Ct, TrainingLuna2dSegmentationDataset
from p2ch13.model import SegmentationAugmentation, MaskTuple

clim = (-1000.0, 300)

def findPositiveSamples(start_ndx=0, limit=100):
    ds = TrainingLuna2dSegmentationDataset(sortby_str='label_and_size')
...
def showCandidate(series_uid, batch_ndx=None, **kwargs):
    ds = TrainingLuna2dSegmentationDataset(series_uid=series_uid, **kwargs)
